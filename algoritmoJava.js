...
//Ingresar 10 calificaciones y sacar el promedio y la calificacion mas baja 
		...
		//Salida: Mostrar el problema		let Calificaciones;
...
ejercicio29(){
	//Entrada: Pedir el valor de v al usuario y definir la variable a
		...
		Escribir.log("La sumas es:", resultado)
}
ejercicio30(){
...
ejercicio31(){
	//ejercicio con el ciclo hasta que 
...
ejercicio32(){
        // ingresad las horas trabajadas de 5 personas y la
		// tarifa de pago calcular el salario, y la
		// sumatoria de todos los salarios.
		console.log("Ejercicio 32")
		
		let salario_cada = 0, horas, presu, sumar_salario, num_trabajadores, i
		
		i = 1
		sumar_salario = 0
		num_trabajadores = parseInt(Leer("digite el numero de trabajadores: "))

		while (i<=num_trabajadores) {
			horas = parseInt(Leer("Digite el valor de horas trabajadas por este trabajador: "))
			presu = parseInt(Leer("Digite la tarifa: "))
			salario_cada = horas*presu
			
			Escribir.log("El valor a pagar de este trabajador es: ",salario_cada)
			
			i = i+1
			sumar_salario = sumar_salario+salario_cada
		}
		
		Escribir.log("El valor total de salarios a pagar es de: ",sumar_salario)		
